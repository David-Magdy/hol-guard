...
def test_guard_run_codex_does_not_override_required_mcp_sandbox(tmp_path):
    home_dir = tmp_path / "home"
    ...
    assert rerun_payload["artifacts"][0]["policy_composition"]["current_action"] == "sandbox-required"
