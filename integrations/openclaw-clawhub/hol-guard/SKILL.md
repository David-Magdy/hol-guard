---
name: hol-guard
description: Install, initialize, or check local HOL Guard security protection for OpenClaw.
version: 1.0.0
...
If protection is degraded, report the failed layer and let the Guard CLI/core documentation drive repair. Do not manually rewrite OpenClaw configuration from this skill unless the core HOL Guard documentation explicitly requires it.
