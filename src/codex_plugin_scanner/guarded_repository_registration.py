...
from .guarded_repository_evidence import GuardedRepositoryEvidence, guarded_repository_evidence_sha256
...
def _github_oidc_token(*, request_url: str, request_token: str, audience: str) -> str:
    ...
    with urllib.request.urlopen(request, timeout=10) as response:  # noqa: S310 - URL is GitHub-provided and HTTPS-validated.
...
def register_guarded_repository_evidence(
    *,
    ...
    with urllib.request.urlopen(request, timeout=15) as response:  # noqa: S310 - endpoint is HTTPS-validated above.
