...
def _looks_like_safe_routine_move(
    ...
    *,
    ...
    if command_name != "mv" or command_index is None:
        return False
    ...
    source = _resolve_move_operand(source_text, cwd=cwd, home_dir=home_dir, strict=True)
    destination = _resolve_move_operand(destination_text, cwd=cwd, home_dir=home_dir, strict=False)
    ...
    try:
        ...
        return False
    if destination_parent != destination.parent:
        return False
