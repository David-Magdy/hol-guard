...
def install_frozen_daemon_runtime() -> None:
    ...
    # The Guard daemon is an independent invocation of the one-file executable.
    # Force PyInstaller to create a fresh extraction root instead of inheriting
    # the parent process's private _MEI runtime directory.
